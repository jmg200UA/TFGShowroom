...
@Component({
  selector: 'actualizarcontstrabajo',
  templateUrl: './actualizarcontstrabajo.component.html',
  styleUrls: ['./actualizarcontstrabajo.component.css']
})
export class ActualizarcontstrabajoComponent implements OnInit {
